<template>
  <li
    ...
    class="select-none cursor-pointer relative focus:outline-none focus:ring-2 focus:ring-blue-500 flex w-full items-center text-left mt-0 mb-0 min-h-[3rem] flex flex-col"
    @click="onClick(item)"
  >
